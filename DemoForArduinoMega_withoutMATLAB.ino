...
#define NUMOFLED 16
#define LEDROWLITTIME 100 //Miliseconds
...
#define BUZZER_MILLISECONDS 300 // How long a buzzer should be on
...
{ 
  ...
  //for(int i = 1; i <= 1; i++) {
    ...
    delay(500); // To get into position
    sendPing();
    ...
    delay(300); // To let the LED light up and finish up
  }
} 
...
void ADCSetup() {
  ...
  bitSet(ADCSRA,ADPS2);
  /* This is to calculate the number of microseconds an ADC read takes
  ...
  ADC_TIME = (float) duration/numberOfEntries;
  */
}
